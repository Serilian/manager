    ...
    return (
        <View>
            <Card>
                ...
                <CardSection style={{flexDirection: 'column', justifyContent: 'center', alignItems: 'center', height: 120}}>
                    <Text style={{alignSelf: 'flex-start',paddingLeft: 20, fontSize: 18}}>Select shift day</Text>
                   <Picker style={{width: '100%', height: 60}} selectedValue={shift} onValueChange={(val)=>onChange('shift', val)}>
